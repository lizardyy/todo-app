...
const DeleteTodo = ({ todoItem }: { todoItem: todoItems }) => {
	...
	return (
		<>
			...
			{/* <!-- START Main Modal --> */}
			<div className={showModal ? "overflow-y-auto flex  overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 z-50 justify-center items-center w-full h-full md:inset-0  bg-black bg-opacity-20" : "hidden"}>
