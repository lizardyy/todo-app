						...
						<div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
							...
							<div className="flex justify-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
								<button
									...
									type="button"
									onClick={handleModal}
									className="mx-1 hover:text-blue-700  border border-gray-200 text-black bg-gradient-to-br from-white to-white hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-grey-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
								>
									Close
								</button>
								{!isLoading ? (
