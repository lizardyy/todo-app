...
const AddTodo = () =>{
    ...
    return (
			<div className="flex justify-center mb-6">
				...
				{/* <!-- START Main Modal --> */}
				<div className={showModal ? "overflow-y-auto flex  overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 z-50 justify-center items-center w-full md:inset-0 h-full bg-black bg-opacity-20" : "hidden"}>
                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <div className="p-4 md:p-5 space-y-4">
                                ...
                                <div className="relative mt-2 rounded-md shadow-sm">
                                    ...
                                    >									
                                        <option selected={status==""} value="new">new</option>
